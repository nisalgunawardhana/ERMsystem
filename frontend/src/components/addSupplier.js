...
function AddSupplier() {
    ...
    return(
        <div className="w-50 container mb-6">
            ...
            <div>
                ...
                <Row>
                    ...
                    <div className="my-3">
                        ...
                        <Button variant="outline-danger" onClick={handleRemoveProduct}>Remove product</Button>
                    </div>
                </Row>
            ...
            <div >
                <h6 className="mt-2">Contract Details</h6>
                <Row>
                    <Col>
                    <Form.Group >
            ...
            <Button className="mt-3 col-md-4" variant="outline-primary" type="submit">Submit</Button>
            </div>
